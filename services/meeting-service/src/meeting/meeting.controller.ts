...
export class MeetingController {
  ...
  async createMeeting(@Payload('user') user: UserData, @Payload('createMeetingDto') createMeetingData: CreateMeeting) {
    console.log(createMeetingData);

    try {
      const meeting = await this.meetingService.createMeeting(user, createMeetingData);
  ...
  async deleteMeeting(@Payload('user') user: MeetingUser, @Payload('id') id: string) {
    try {
      await this.meetingService.deleteMeeting(id, user);
